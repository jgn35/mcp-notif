...
The Android receiver app and the Firebase/FCM project configuration are deferred
(V1 scope is single-user, single-device, self-hosted).
...
Deferred (separate builds): Android receiver app, Firebase/FCM project setup,
Podman/Apache deployment.
